...
from auth.entrypoint.di.containers import cli_container
from auth.entrypoint.web.config import get_web_config
from auth.infrastructure.persistence.alembic.config import get_alembic_config
from auth.presentation.cli import (
    make_migrations,
    migrate,
    rollback,
    start_uvicorn,
...
def main(context: Context) -> None:
    ...
    uvicorn_config = UvicornConfig(
        app="auth.entrypoint.web.application:app_factory",
