...
from user.entrypoint.di.containers import cli_container
from user.entrypoint.web.config import get_web_config
from user.infrastructure.persistence.alembic.config import get_alembic_config
from user.presentation.cli import (
    make_migrations,
    migrate,
    rollback,
    start_uvicorn,
...
def main(context: Context) -> None:
    ...
    uvicorn_config = UvicornConfig(
        app="user.entrypoint.web.application:app_factory",
