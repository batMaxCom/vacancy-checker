...
from vacancy.application.common.application_error import (
    ApplicationError,
    ApplicationTypeError,
)
from vacancy.domain.common.domain_errors import DomainError, DomainTypeError
from vacancy.infrastructure.common.infrastructure_errors import InfrastructureError
from vacancy.presentation.web.schemas.base import ErrorResponse
