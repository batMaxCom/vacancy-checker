...
from search.entrypoint.di.containers import cli_container
from search.entrypoint.web.config import get_web_config
from search.infrastructure.persistence.alembic.config import get_alembic_config
from search.presentation.cli import (
    make_migrations,
    migrate,
    rollback,
    start_uvicorn,
...
def main(context: Context) -> None:
    ...
    uvicorn_config = UvicornConfig(
        app="search.entrypoint.web.application:app_factory",
